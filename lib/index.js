...
exports.get_public_ip  = function(cb) {
  ...
  needle.get(url, function(err, resp) {
    if (!err)
      ip = resp.body && resp.body.match(regex)[1];
    else if (err.code == 'ECONNRESET')
      return exports.get_public_ip(cb);

    cb(err, ip); // should return one or the other
  })
...
exports.get_network_interfaces_list = os_functions.get_network_interfaces_list;